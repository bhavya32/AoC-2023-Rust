...
fn findNums(l:&str)->Vec<numDetails> {
    let mut num:u32 = 0;
    let mut start_idx:usize = 0;
    //let mut end_idx:u32 = 0;
    let mut v: Vec<numDetails> = Vec::new();
    for (i, chr) in l.chars().enumerate() {
        if chr.is_digit(10) {
            if num == 0 {
                start_idx = i;
            }
            num *= 10;
            num += chr.to_digit(10).unwrap();
...
fn search(v: &mut Vec<Vec<numDetails>>, id:usize, j:usize) ->u32 {
    for x in 0..v[id].len(){
        //for i in v[id] {
        let mut i = &mut v[id][x];
...
fn main() {
    let a = ".........798...145.........629....579.....455.....................130.............243.................154........167........................
...
.....353............................914........105.................829...........112...............75.......................................";
    ...
    let mut numsVec: Vec<Vec<numDetails>> = vec![];
    for i in 0..collection.len() {
    //for line in collection{
        let mut line = collection[i];
        numsVec.push(findNums(line));
    }
    
    //iterate over numsVec and find every symbol

    for i in 0..collection.len() {
        let ch_arr = collection[i].chars();
        for (j, chr) in ch_arr.enumerate() {
            if chr != '*' {continue;}
            
            //check the every index around the symbol
            let lspace = j!=0;
            let rspace = j!=collection[i].len();
            let uspace = i!=0; 
            let dspace = i != collection.len();
            let mut foundVec:Vec<u32> = Vec::new();
            if lspace {
                foundVec.push(search(&mut numsVec, i, j-1));
            }
            ...
            if uspace {
                if lspace{
                    foundVec.push(search(&mut numsVec, i-1, j-1));
                }
                if rspace{
                    foundVec.push(search(&mut numsVec, i-1, j+1));
                }
                foundVec.push(search(&mut numsVec, i-1, j));
            }
            ...
            foundVec.retain(|&x| x!= 0);
            dbg!(&foundVec);
            if (foundVec.len() == 2) {
                sum  += foundVec[0] * foundVec[1];
            }
        } 
    }
